...
=item bitmap_magick([I<render_mode>])   **** NYI ****
...
should be called as follows:
    ...
    my $bbox = $glyph.outline.bbox();
    my $xmin = $bbox.x-min;

=item outline.decompose
